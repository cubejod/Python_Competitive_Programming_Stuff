...
get easy problems first to minimize get penalty points
make sure your code resets variables to the right number, sometimes u need to reset to 1 instead of 0
if you have two loops nested in a loop, remove one and it'll still be O(n^2), u need to remove both to improve time complexity
